    ...
    <main>
      <div id="grid-container">
            <div id="div-daniel" class="grid-element">
                ...
                <h3>I received a job offer mid-course, and the subjects I learned were current, 
                ...
                <p> 
                    ...
                    I’ve successfully switched careers, working as a Software Engineer
                    at a VR startup. ”
                </p>
            </div>
            ...
            <div id="div-jeanette" class="grid-element">
                ...
                <p> “ Thank you for the wonderful experience! I now have a job I really enjoy,
            ...
            <div id="div-patrick" class="grid-element">
                ...
                <h3>Awesome teaching support from TAs who did the bootcamp themselves. 
                    Getting guidance from them and learning from their experiences was easy. 
                </h3>
                <p>“ The staff seem genuinely concerned about my progress which 
                    I find really refreshing. 
                    The program gave me the confidence necessary to be able to go 
                    out in the world 
                    and present myself as a capable junior developer.
                        The standard is above the rest. 
                    You will get the personal attention you need 
                    from an incredible community of smart
                        and amazing people. ”
                </p>
            </div>
            <div id="grid-kira" class="grid-element">
                ...
                <p>
                    ...
                    It took my learning to the next level in a way that no tutorial could 
                    ever have. In fact, I’ve often referred to it during interviews as an 
